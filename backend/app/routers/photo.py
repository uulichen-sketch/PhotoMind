    ...
    for photo in photos:
        try:
            ...
            photo_data = PhotoMetadata(
                ...
                gps_latitude=float(photo.get('gps_latitude')) if photo.get('gps_latitude') else None,
                gps_longitude=float(photo.get('gps_longitude')) if photo.get('gps_longitude') else None,
